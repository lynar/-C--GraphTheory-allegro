...
inline int Graphic::keyPressed() const
{
    return keypressed();
}
inline int Graphic::keyGet(int code) const
{
    return key[code];
}
inline int Graphic::keyRead() const
{
    return (readkey() >> 8);
}

inline pSurface Graphic::getSprite(int s) const
{
    return pSprites[s];
}
inline pSurface Graphic::getSpritePlayer(int s) const
{
    return pSpritesPlayer[s];
}
